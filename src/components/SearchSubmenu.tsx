      ...
      <div className="w-full max-w-3xl bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
        ...
        <div className="bg-[var(--bg-subtle)] border-b border-[var(--border-color)] px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="font-bold text-lg text-[var(--text-main)]">Cerca nei Memo (Notula Search)</h2>
              <p className="text-xs text-[var(--text-muted)]">Cerca memo per titolo, testo, data esatta o ID</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 pb-2 space-y-4">
          ...
          <div className="flex gap-3 items-center">
            <div className="relative flex-1">
              {searchMode === 'text' && (
                <input
                  type="text"
                  placeholder="Digita parole chiave del titolo o contenuto..."
                  value={textQuery}
              ...
              {searchMode === 'id' && (
                <input
                  type="text"
                  placeholder="Es. n_1724000000-12"
                  value={idQuery}
            ...
            <div className="flex items-center gap-1 bg-[var(--bg-subtle)] p-1 rounded-xl border border-[var(--border-color)]">
              ...
              >
                ...
                <option value="punctual">Solo Puntuali (Non ricorrenti)</option>
          ...
          <div className="text-xs text-[var(--text-muted)] flex justify-between items-center px-1">
            <span>Trovati <strong>{results.length}</strong> memo corrispondenti</span>
        ...
        <div className="flex-1 overflow-y-auto p-6 pt-2 space-y-3">
          {results.length === 0 ? (
            <div className="py-12 text-center text-[var(--text-muted)] space-y-2">
              ...
              <p className="text-sm font-medium">Nessun memo corrisponde ai criteri specificati.</p>
              <p className="text-xs">Prova a cambiare query o selezionare un'altra modalità di ricerca.</p>
            </div>
          ) : (
            results.map((memo) => {
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      ...
                      <button
                        ...
                        title="Esporta singolo memo (JSON/XML/MD/TXT)"
                      >
